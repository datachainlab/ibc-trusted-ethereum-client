...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/datachainlab/ibc-trusted-ethereum-client/tests/chains/tendermint/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
