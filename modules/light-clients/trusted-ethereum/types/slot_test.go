...
func Test_keccak256AbiEncodePacked(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"address string,uint256*3", args{data: []interface{}{"0x14723a09acff6d2a60dcdf7aa4aff308fddc160c", big.NewInt(1000), big.NewInt(2), big.NewInt(3)}},
			hexutil.MustDecode("0xba8d5962e0104473dd6a49779d2afa5102c737ee651e58dc159c01d3cc38b5ea"), false,
		},
		{
			"address,uint256*3", args{data: []interface{}{common.HexToAddress("0x14723a09acff6d2a60dcdf7aa4aff308fddc160c"), big.NewInt(1000), big.NewInt(2), big.NewInt(3)}},
			hexutil.MustDecode("0xba8d5962e0104473dd6a49779d2afa5102c737ee651e58dc159c01d3cc38b5ea"), false,
		},
	}
